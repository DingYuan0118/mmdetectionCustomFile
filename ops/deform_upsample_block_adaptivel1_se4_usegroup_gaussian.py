...
class DeformUpsampleBlock(DeformConv2dPack):
    ...
    def forward(self, x):
        ...
        # add gaussian_kernel
        weight_tmp_ = weight.reshape(-1, self.scale**2, 1,self.kernel_size[0], self.kernel_size[1]) + self.gaussian_kernel
